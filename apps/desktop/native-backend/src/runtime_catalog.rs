...
const BUILT_IN_RUNTIME_DEFINITIONS: &[BuiltInRuntimeDefinition] = &[
    ...
    BuiltInRuntimeDefinition {
        ...
        bin_env_var: "BIFROSTWRITE_GROK_ACP_BIN",
    ...
    BuiltInRuntimeDefinition {
        ...
        bin_env_var: "BIFROSTWRITE_KILO_ACP_BIN",
    ...
    BuiltInRuntimeDefinition {
        ...
        bin_env_var: "BIFROSTWRITE_OPENCODE_ACP_BIN",
        acp_args: SHELL_ACP_ARGS,
        acp_protocol: AcpProtocolFlavor::Current,
        supports_native_resume: false,
    },
    ...
    fn built_in_launch_contracts_are_stable() {
        ...
        let expected = vec![
            ...
            (
                GROK_RUNTIME_ID,
                "grok",
                Some("BIFROSTWRITE_GROK_ACP_BIN"),
                vec![
            ...
            (
                KILO_RUNTIME_ID,
                "kilo",
                Some("BIFROSTWRITE_KILO_ACP_BIN"),
                vec!["acp".to_string()],
            ),
            (
                OPENCODE_RUNTIME_ID,
                "opencode",
                Some("BIFROSTWRITE_OPENCODE_ACP_BIN"),
                vec!["acp".to_string()],
            ),
        ];
