...
const EN_US_AFF: &str = include_str!("../resources/spellcheck/bundled/en-US/dictionary.aff");
const EN_US_DIC: &str = include_str!("../resources/spellcheck/bundled/en-US/dictionary.dic");
const ES_ES_AFF: &str = include_str!("../resources/spellcheck/bundled/es-ES/dictionary.aff");
const ES_ES_DIC: &str = include_str!("../resources/spellcheck/bundled/es-ES/dictionary.dic");
