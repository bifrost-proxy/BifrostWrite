...
export const livePreviewTheme = EditorView.baseTheme({
    ...
    ".cm-lp-html-quote::before": { content: '"“"' },
    ".cm-lp-html-quote::after": { content: '"”"' },
    ".cm-lp-html-ruby": { display: "ruby" },
    ".cm-lp-html-ruby-text": {
        display: "ruby-text",
        fontSize: "0.72em",
        color: "var(--text-secondary)",
    },
    ".cm-lp-html-ruby-parenthesis": { display: "none" },
    ".cm-lp-html-block": {
        position: "relative",
    ...
    ".cm-lp-html-block > :first-child": { marginTop: "0" },
    ".cm-lp-html-block > :last-child": { marginBottom: "0" },
    ".cm-lp-html-edit": {
        position: "absolute",
        top: "0.48rem",
        right: "0.55rem",
    ...
    ".cm-lp-html-block:hover .cm-lp-html-edit, .cm-lp-html-edit:focus-visible": {
        opacity: "1",
    },
    ".cm-lp-html-edit:hover": {
        color: "var(--accent)",
        borderColor: "color-mix(in srgb, var(--accent) 52%, var(--border))",
    },
    ".cm-lp-html-edit:focus-visible": {
        outline: "2px solid color-mix(in srgb, var(--accent) 38%, transparent)",
        outlineOffset: "2px",
    },
    ".cm-lp-html-block p": { margin: "0.55em 0" },
    ".cm-lp-html-block h1, .cm-lp-html-block h2, .cm-lp-html-block h3, .cm-lp-html-block h4, .cm-lp-html-block h5, .cm-lp-html-block h6":
        {
    ...
    ".cm-lp-html-block h1": { fontSize: "1.65em" },
    ".cm-lp-html-block h2": { fontSize: "1.4em" },
    ".cm-lp-html-block h3": { fontSize: "1.2em" },
    ".cm-lp-html-block h4, .cm-lp-html-block h5, .cm-lp-html-block h6": {
        fontSize: "1.05em",
    },
    ".cm-lp-html-block a[data-html-preview-link]": {
        color: "var(--accent)",
        textDecoration: "underline",
        textUnderlineOffset: "3px",
        cursor: "pointer",
    },
    ".cm-lp-html-block mark": {
        padding: "0 0.18em",
        color: "var(--highlight-text)",
        background: "var(--highlight-bg)",
        borderRadius: "3px",
    },
    ".cm-lp-html-block code, .cm-lp-html-block kbd": {
        fontFamily: "var(--font-mono), ui-monospace, monospace",
        fontSize: "0.88em",
        color: "var(--code-string)",
    ...
    ".cm-lp-html-block pre": {
        margin: "0.7em 0",
        padding: "0.75em 0.85em",
        overflow: "auto",
        background: "var(--code-fence-background)",
        border: "1px solid var(--code-fence-border-color)",
        borderRadius: "var(--code-fence-radius)",
    },
    ".cm-lp-html-block pre code": {
        padding: "0",
        background: "transparent",
        border: "0",
    },
    ".cm-lp-html-block blockquote": {
        margin: "0.7em 0",
        padding: "0.2em 0 0.2em 0.85em",
        color: "var(--text-secondary)",
        borderLeft: "3px solid var(--accent)",
    },
    ".cm-lp-html-block ul, .cm-lp-html-block ol": {
        margin: "0.55em 0",
        paddingLeft: "1.5em",
    },
    ".cm-lp-html-block table": {
        width: "100%",
        margin: "0.7em 0",
    ...
    ".cm-lp-html-block th, .cm-lp-html-block td": {
    ...
    ".cm-lp-html-block tr:last-child > *": { borderBottom: "0" },
    ".cm-lp-html-block tr > *:last-child": { borderRight: "0" },
    ".cm-lp-html-block details": {
        margin: "0.65em 0",
    ...
    ".cm-lp-html-block > details:only-of-type": {
        margin: "0",
        padding: "0",
        background: "transparent",
        border: "0",
    },
    ".cm-lp-html-block summary": {
        color: "var(--text-primary)",
        fontWeight: "600",
        cursor: "pointer",
    },
    ...
    ".cm-lp-html-block figcaption, .cm-lp-html-block caption": {
        color: "var(--text-secondary)",
        fontSize: "0.86em",
        textAlign: "center",
    },
