...
## BifrostWrite compatibility boundary

BifrostWrite's vendored build keeps the ACP Rust SDK at `0.14.0` and the wire protocol at ACP v1 while running the OpenAI Codex `rust-v0.147.0` crates.
